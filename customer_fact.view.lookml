- view: customer_fact
  ...
  - dimension: merch_name
    ...
    type: string
    sql: ${TABLE}.COHORT_MERCH_ID = ${merchant_dim.merch_id} and ${merchant_dim.ignore} = 0 and ${merchant_dim.date_to} = '2199-12-31' 
  ...
  - measure: l365_aov_aud_accepted
    type: avg
    sql: ${TABLE}.L365_AOV_AUD_ACCEPTED
    value_format: '"$"#,###'
  ...
  - measure: l365_aur_aud_accepted
    type: avg
    sql: ${TABLE}.L365_AUR_AUD_ACCEPTED
    value_format: '"$"#,###'
  ...
  - measure: l365_gmv_converted_usd_accepted
    ...
    description: 'Gross merchant value converted in USD, last 365 days' 
    type: sum
    sql: ${TABLE}.L365_GMV_CONVERTED_USD_ACCEPTED
    value_format: '"$"#,###'

  - measure: l365_gmv_aud_accepted
    label: 'l365 Gmv (in $AUD) accepted'
    description: 'Gross merchant value (merchant pricing CCY in AUD) in last 365 days' 
    type: sum
    sql: ${TABLE}.L365_GMV_AUD_ACCEPTED
    value_format: '"$"#,###'
  ...
  - measure: l365_mv_converted_usd_accepted
    ...
    description: 'Merchant value converted in USD, last 365 days' 
    type: sum
    sql: ${TABLE}.L365_MV_CONVERTED_USD_ACCEPTED
    value_format: '"$"#,###'

  - measure: l365_mv_aud_accepted
    label: 'l365 Mv (in $AUD) accepted'
    description: 'Merchant value (merchant pricing CCY in AUD) in last 365 days' 
    type: sum
    sql: ${TABLE}.L365_MV_AUD_ACCEPTED
    value_format: '"$"#,###'
  ...
  - measure: l365_num_item_accepted_au_merch
    label: 'l365 Number of Items (from AU merchant) accepted'
    description: 'total number of items (merchant pricing CCY in AUD) in accepted orders in last 365 days'
    type: sum
    sql: ${TABLE}.L365_NUM_ITEM_ACCEPTED_AU_MERCH
  ...
  - measure: l365_num_order_accepted_au_merch
    label: 'l365 Number of Orders (from AU merchant) accepted'
    description: 'total number of accepted orders (merchant pricing CCY in AUD) in last 365 days'
    type: sum
    sql: ${TABLE}.L365_NUM_ORDER_ACCEPTED_AU_MERCH
  ...
  - measure: lifetime_aov_converted_usd_accepted
    ...
    description: 'Average order value converted in USD, lifetime' 
    type: avg
    sql: ${TABLE}.LIFETIME_AOV_CONVERTED_USD_ACCEPTED
    value_format: '"$"#,##0.0'

  - measure: lifetime_aov_aud_accepted
    label: 'lifetime Aov (in $AUD) accepted'
    description: 'Average order value in AUD (merchant pricing CCY), lifetime' 
    type: avg
    sql: ${TABLE}.LIFETIME_AOV_AUD_ACCEPTED
    value_format: '"$"#,###'
  ...
  - measure: lifetime_aur_converted_usd_accepted
    ...
    description: 'Average unit retail converted in USD, lifetime' 
    type: avg
    sql: ${TABLE}.LIFETIME_AUR_CONVERTED_USD_ACCEPTED
    value_format: '"$"#,###'

  - measure: lifetime_aur_aud_accepted
    label: 'lifetime Aur (in $AUD) accepted'
    description: 'Average unit retail in AUD (merchant pricing CCY), lifetime'
    type: avg
    sql: ${TABLE}.LIFETIME_AUR_AUD_ACCEPTED
    value_format: '"$"#,###'
  ...
  - measure: lifetime_gmv_converted_usd_accepted
    ...
    description: 'Gross merchant value converted in USD, lifetime' 
    type: sum
    sql: ${TABLE}.LIFETIME_GMV_CONVERTED_USD_ACCEPTED
    value_format: '"$"#,###'

  - measure: lifetime_gmv_aud_accepted
    label: 'lifetime Gmv (in $AUD) accepted'
    description: 'Gross merchant value (merchant pricing CCY in AUD) in lifetime' 
    type: sum
    sql: ${TABLE}.LIFETIME_GMV_AUD_ACCEPTED
    value_format: '"$"#,###'
  ...
  - measure: lifetime_mv_converted_usd_accepted
    ...
    description: 'Merchant value converted in USD, lifetime' 
    type: sum
    sql: ${TABLE}.LIFETIME_MV_CONVERTED_USD_ACCEPTED
    value_format: '"$"#,###'
    
  - measure: lifetime_mv_aud_accepted
    label: 'lifetime Mv (in $AUD) accepted'
    description: 'Merchant value (merchant pricing CCY in AUD) in lifetime' 
    type: sum
    sql: ${TABLE}.LIFETIME_MV_AUD_ACCEPTED
    value_format: '"$"#,###'
  ...
  - measure: lifetime_num_item_accepted_au_merch
    label: 'lifetime Number of Items (from AU merchant) accepted'
    description: 'total number of items (merchant pricing CCY in AUD) in accepted orders in lifetime'
    type: sum
    sql: ${TABLE}.LIFETIME_NUM_ITEM_ACCEPTED_AU_MERCH
  ...
  - measure: lifetime_num_order_accepted_au_merch
    label: 'lifetime Number of Orders (from AU merchant) accepted'
    description: 'total number of accepted orders (merchant pricing CCY in AUD) in lifetime'
    type: sum
    sql: ${TABLE}.LIFETIME_NUM_ORDER_ACCEPTED_AU_MERCH  
